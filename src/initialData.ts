...
const LEGACY_TRAINING_WEEKS: { id: number; week: string; sessions: TrainingSession[] }[] = [
...
export const INITIAL_TRAINING_WEEKS: TrainingWeek[] = LEGACY_TRAINING_WEEKS.map((week, index) => ({
  id: week.id,
  weekNumber: index + 1,
  weekLabel: week.week,
...
export const INITIAL_FORMATION: FormationData = {
  ...
  module: '4-3-3',
  positions: {},
  substitutes: [null, null, null, null, null, null, null, null, null],
};
